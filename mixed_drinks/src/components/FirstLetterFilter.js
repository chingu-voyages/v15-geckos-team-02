...
const FirstLetterFilter = props => {
    return (
        <div className="container">
            ...
            <p className="container__firstLetters" onClick={props.handleClickLetter}><span>A</span>/<span>B</span>/<span>C</span>/<span>D</span>/<span>E</span>/
            ...
            <p onClick={(e) => props.handleClickLetter}></p>
        </div>
    )
}
